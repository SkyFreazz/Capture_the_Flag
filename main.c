...
int main( void )
{
  ...
  Sleep( 1000 );
  mvt_l_motor(l_sn, 3000,  1000,  5, l_state);
  Sleep( 1000 );
  mvt_r_motor(r_sn,  3000,  1000,  5, r_state);
  Sleep(3000); 
  turn_arm(a_sn, 90, 0,  3,  a_state, ARM);
  Sleep(1000);
  turn_arm(a_sn, -90, 0,  3,  a_state, ARM);
  Sleep(3000); 
  turn_arm(sm_sn, -60, 0,  3,  sm_state, M_SENSOR);
  Sleep(1000);
  turn_arm(sm_sn, 90, 0,  3,  sm_state, M_SENSOR);
  return ( 0 );
}